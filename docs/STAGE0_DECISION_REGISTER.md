...
| DEC-004 | Reference line speed, trigger rate, maximum decision latency, reject mechanism, and timing margin | Zamri Ares | Machine geometry, encoder/trigger design, reject distance, speed range, and measurement method | Required before Stage 0 exit | Open |
